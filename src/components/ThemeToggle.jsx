...
const ThemeToggle = ({ isDark, onToggle, className = '' }) => {
  return (
    ...
    >
      ...
      >
        {isDark ? (
          <svg className="w-3 h-3 text-blue-600 m-0.5" fill="currentColor" viewBox="0 0 20 20">
            <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z" />
          </svg>
        ) : (
          <svg className="w-3 h-3 text-yellow-500 m-0.5" fill="currentColor" viewBox="0 0 20 20">
